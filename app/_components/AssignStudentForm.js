...
import { assignStudentAction, assignTeacherAction } from "../_lib/action";
import { toast } from "react-toastify";

const AssignStudentForm = ({ students, teachers }) => {
  const initialState = {
    errors: {
      name: null,
    },
  ...
  const [state, action] = useFormState(assignStudentAction, initialState);
