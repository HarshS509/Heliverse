"use client";
import { getTeacherById, updateTeacherAction } from "@/app/_lib/action";
...
const ModifyTeacherForm = () => {
  ...
  const [state, action] = useFormState(updateTeacherAction, initialState);
  ...
  useEffect(() => {
    const fetchTeacher = async () => {
      try {
        ...
        setTeacher(data.data.data.teacher);
      } catch (error) {
